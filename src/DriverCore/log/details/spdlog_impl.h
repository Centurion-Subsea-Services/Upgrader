...
inline std::shared_ptr<spdlog::logger> spdlog::logger::createLogger(int loglevel, std::string logName, std::string fileName) {
    // Create a rotating logger to limit the file profile to 3 files of 5 Meg
    std::shared_ptr<spdlog::logger> logger = spdlog::rotating_logger_st(logName, fileName, 5000000, 3);
    // trace = 0,
    // debug = 1,
    // info = 2,
    // warn = 3,
