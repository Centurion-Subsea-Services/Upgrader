...
* Copy the source [folder](https://github.com/gabime/spdlog/tree/master/include/spdlog) to your build tree and use a C++i1 compiler.
...
#include <fmt/ostr.h> // must be included
void user_defined_example()
{
