 ...
 /**
  * Class: Use to read an INI file into easy-to-access name/value pairs.
  */
 class INIReader {
    public:
     /**
...
/**
 * @param section the section to read the value list from 
 * @return a SET of value names
 */  
 ...
 /**
  * @param section the section to read the value list from 
  * @return a map of the values in a section
  */ 
...
/**
 * @brief get a value from the ini file with a given type
 * @param section the section of the INI file to read
 * @param name the value name to read
 * @return the value rad from the file
 * @throws std::runtime_error if the value does not exist
 */  
 template <typename T>
 ...
 * @param section the section of the INI file to read
 * @param name the value name to read
 * @param default_v the deafault value to return if the value does not exist
 * @return the value rad from the file
 * @throws std::runtime_error if the value does not exist
 */  
template <typename T>
 ...
 /**
  * Class: use to write an INI file
  */ 
 class INIWriter {
    public:
     INIWriter(){};
     /**
      * @brief write the INI file with the passed INI map
      * @param filepath place to write the file
      * @param reader the object with the configuration map
      */
